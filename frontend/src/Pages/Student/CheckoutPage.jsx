  ...
  if (items.length === 0 && !result) {
    return (
      <div className="min-h-screen flex items-center justify-center px-6">
        <div className="card max-w-sm w-full text-center py-12 animate-fade-in">
          <div className="w-16 h-16 rounded-2xl bg-gray-100 dark:bg-gray-700 flex items-center justify-center mx-auto mb-4">
            <ShoppingBag size={28} className="text-gray-400" />
          </div>
          <p className="font-bold text-gray-700 dark:text-gray-300 text-lg mb-2">Cart is empty</p>
          <p className="text-sm text-gray-400 mb-6">Add some meals before checking out</p>
          <button onClick={() => navigate("/student/canteens")} className="btn-primary w-full">
            Browse Canteens
          </button>
        </div>
      </div>
