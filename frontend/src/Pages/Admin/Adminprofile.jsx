...
const validateProfile = (form) => {
  ...
  else if (!/^(\+?60|0)\d{8,10}$/.test(form.phone.replace(/\s/g, ''))) errors.phone = 'Enter a valid phone number';
            ...
            <div className="px-6 pb-5">
              ...
              <form onSubmit={handleProfileSave} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <InputField label="Phone Number" name="phone" value={form.phone} onChange={handleFormChange} error={profileErrors.phone} placeholder="e.g. 0112345678" icon={Phone} />
