        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { name: "Spice Garden", tag: "Local Flavours", img: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600&q=80", rating: "4.7", meals: "31 meals" },
              { name: "Bite & Brew", tag: "Café", img: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&q=80", rating: "4.8", meals: "18 meals" },
            ].map((c, index) => (
              <div
                key={c.name}
