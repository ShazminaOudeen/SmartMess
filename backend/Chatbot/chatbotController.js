...
const sendMessage = async (req, res) => {
  try {
    ...
    const systemPrompt = `You are SmartMess Assistant, a helpful AI chatbot built into the SmartMess canteen management system.
...
4. Be concise, friendly, and professional. Use **bold** for key terms, names, amounts, and statuses.
5. Use the real data below to give accurate, personalized answers.
6. At the end of EVERY response (except very short 1-line answers), add 2-3 relevant follow-up suggestions as a numbered list on new lines. Example:
...
- Keep responses under 200 words unless listing many items
